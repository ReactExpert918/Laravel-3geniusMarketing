...
<!-- report start here -->
  <div class="row "  >
 <form id="frmProducts" method="post"   action="{{route('admin.roi-date')}}" style="width:100% !important;">
     @csrf
...
@endphp
                                <tr>
                                     <td>     <a href="{{ route('admin.users.detail', $p->user_id) }}" class="avatar avatar-sm rounded-circle mr-3">
                                        {{ $userName}}
                                    </a> </td>
                                    <td>{{ $planName }}</td>
