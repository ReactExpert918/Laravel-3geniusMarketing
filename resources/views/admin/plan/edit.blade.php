                        ...
                        <div class="form-group">
                            <div class="row pb-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" min="0" class="form-control form-control-lg "    name="days"  value="{{$plan->days}}"  placeholder="@lang('Days')" required>
                                        <div class="input-group-append">
                                            <!-- <span class="input-group-text">{{$general->cur_sym}}</span> -->
                                            <span class="input-group-text">#</span>
                                        </div>
...
<!-- for($i = 1; $i <= intval($general->matrix_height); $i++) -->
  ...
  <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" min="0" class="form-control form-control-lg "    name="roi"  value="{{$plan->roi}}" id="roi"  onkeyup="testcalc()"  placeholder="@lang('ROI')" required>
                                        <div class="input-group-append">
                                            <!-- <span class="input-group-text">{{$general->cur_sym}}</span> -->
                                            <span class="input-group-text">%</span>
                                        </div>
