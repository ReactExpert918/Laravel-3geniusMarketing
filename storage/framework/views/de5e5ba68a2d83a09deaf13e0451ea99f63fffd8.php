...
<!-- report start here -->
  <div class="row "  >
 <form id="frmProducts" method="post"   action="<?php echo e(route('admin.roi-date')); ?>" style="width:100% !important;">
     <?php echo csrf_field(); ?>
...
?>
                                <tr>
                                     <td>     <a href="<?php echo e(route('admin.users.detail', $p->user_id)); ?>" class="avatar avatar-sm rounded-circle mr-3">
                                        <?php echo e($userName); ?>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    ...
    <?php if(request()->path() == 'admin/manage-pin' || request()->path() == 'admin/manage-pin-date'): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel\upwork2\resources\views/admin/roi/roi.blade.php ENDPATH**/ ?>